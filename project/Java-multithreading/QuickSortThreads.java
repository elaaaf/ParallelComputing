...
public class QuickSortThreads implements Runnable{
    
        int[] array;
        int My_start,My_end;
        
     QuickSortThreads(int[] data,int start,int end) {
            this.array=data;
            this.My_start=start;
            this.My_end=end;
        }
...
/*------------------------------------------------------------------*/
     ...
     public static void main(String[] args) {
            ...
            Thread t1=new Thread(new QuickSortThreads(Array,0,s-1));
            Thread t2=new Thread(new QuickSortThreads(Array,s+1,Array.length-1));
            t1.start();
            t2.start();
